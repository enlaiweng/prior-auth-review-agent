...
| 2026-09-10 | Repository created; hours committed: 10 per week; models: claude-sonnet-5, claude-sonnet-4-6; ADR-6 answer: None | Scope | Sets the hours assumption the week-two check tests against; pins the versions the version log tracks | ARCHITECTURE.md |
